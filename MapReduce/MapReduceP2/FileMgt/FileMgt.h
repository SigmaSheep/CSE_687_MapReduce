...
public:
	...
	void printPairVector(const std::vector<std::pair<std::string, std::string>> input_vector);
	void printVectorVector(const std::vector<std::vector<std::string>> input_vector);
	std::string createMedianFile(const std::string media_path);
	std::string createOutputFile(const std::string out_path);
	std::vector<std::pair<std::string, std::string>> readList(const std::vector<std::string> meidan_file_list);
